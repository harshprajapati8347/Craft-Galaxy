  ...
  <>
      ...
      <div className="tw-container grid lg:grid-cols-2 place-items-center gap-x-32">
        <article>
          ...
          <p className="mt-8 max-w-lg leading-loose ">
            We come from a place and time forgotten. Our story is one of revival
            and reconnection to craft. Get connected to the Craft Galaxy, way of
            life through a journey into the Galaxy!
          </p>
          <Link
            to="/products"
        ...
        <article id="showcase-image" className="relative hidden lg:block">
          <img
            ...
            src="https://images-na.ssl-images-amazon.com/images/I/915d8t060fL._SL1500_.jpg"
          />
          {/* <img
            alt="craft back"
      ...
      <div className="tw-container py-14">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          <Panel
            ...
            name="Carnival Wall Hanger"
            image="https://cdn.shortpixel.ai/client/q_glossy,ret_img,w_897/https://akkaara.co.in/wp-content/uploads/2019/11/15-897x1091.jpg"
            price={14000}
          />
          <Panel
            id="rec7JInsuCEHgmaGe"
            name="Clay Jug Set"
            image="https://cdn.shortpixel.ai/client/q_glossy,ret_img,w_897/https://akkaara.co.in/wp-content/uploads/2019/09/Teapot-897x1091.jpg"
            price={799}
          />
          <Panel
            id="recNZ0koOqEmilmoz"
            name="Engraved Planter"
            image="https://cdn.shortpixel.ai/client/q_glossy,ret_img,w_897/https://akkaara.co.in/wp-content/uploads/2019/01/planterV_Full_product-897x1091.jpg"
            price={5999}
          />
        </div>
    ...
    <section id="services" className="bg-blue-400">
      <div className="transform py-20 xl:py-0 xl:translate-y-20 tw-container text-blue-50">
        <div className="grid grid-rows-2 lg:grid-rows-1 lg:grid-cols-2 items-center gap-y-4">
          ...
          We come from a place and time forgotten. Our story is one of revival and reconnection to craft. Get connected to the Craft Galaxy, way of life through a journey into the Galaxy! 
          </p>
        </div>
        <div className="mt-16 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 text-center gap-10">
          <ServiceBox
            title="Vision"
            content="A country that holds heavy potential & skilled brains but lacks in utilizing them, we (craft galaxy) want to build a platform, a company that pays for skills and for the development of Tribal, that hold heavy skills and yet are not financially evolved and recognized. our vision is to deliver India's best cultural art N craft nationally & internationally. Our team wants to contribute in Make in India Initiative with our solution and Our Idea."
          >
            <svg
              className="w-full"
              stroke="currentColor"
            ...
            >
              <path
                d="M203.97 23l-18.032 4.844 11.656 43.468c-25.837 8.076-50.32 
                            ...
                            1.25-2.25 66.375-116.592z"
              ></path>
            </svg>
          </ServiceBox>
          <ServiceBox
            title="Mission"
            content="To cultivate employment among the Tribal and low earning beings & to deliver Indian art n craft all around the world, that improves there life financially & contribute in making India an AtmaNirbhar country, a country totally self-dependent & self-employed that directly and indirectly improves & develops employment & finance of the country. our mission is to revolutionize Indian E-market that reduces our international dependency & boosts national growth."
          >
            <svg
              className="w-full"
              stroke="currentColor"
          ...
          <ServiceBox
            title="Strategy"
            content="We commit to connect & create a huge market link nationally & internationally,to trades the handly made and crafted products by the Tribal, who represent pure Indian folk craft & art culture.
            products will be cheaper & genuine than other international online markets, we also plan to introduce this to our craftsmen and tribal groups by visiting and campaining throughout the nation& explaining the strategy to the areas that hold Indian craft n culture and develop pure handmade materials."
          >
            <svg
              className="w-full"
              stroke="currentColor"
    ...
    <section id="newsletter">
      <div className="tw-container my-16 md:my-32 lg:my-64">
        <h2 className="font-bold">Join us and get 20% off</h2>
